...
- Keep work within 32 blocks and 15 minutes. If an imported build needs longer, finish or let the current authorization expire, inspect progress, and request a new approval bound to the same digest and origin. Never attack players or mobs, use explosives, invoke server commands, or ask for a sandbox/subagent.
